...
export default function Membership({
  ...
  return (
    <section className=" max-w-screen-xl mx-auto px-6 py-10 flex items-center justify-center">
            ...
            <CardContent>
              ...
              <div className="space-y-5">
                {features.map((feature, index) => (
                  <div
                    key={index}
                    className="flex items-center gap-3 border-l border-brand-500 border-brand-500  bg-gradient-to-r from-[#0e0e02] to-brand-950 p-2.5"
                  >
                    <Image
