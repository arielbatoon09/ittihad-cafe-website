    ...
    <section className="relative h-screen w-full flex items-center justify-center bg-black">
      ...
      <div className="relative z-20 max-w-3xl mx-auto px-8 text-center">
        ...
        <p className="text-lg md:text-xl text-white/90 leading-relaxed">
          Welcome to Premier Interior Care, where gaming meets luxury. Whether
          you're here to dominate in esports, stream your gameplay, or just
          unwind with friends, we've got you covered.
        </p>
      </div>
    </section>
  );
