      ...
      <div className="max-w-3xl w-full">
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-gray-400">
            If this question is most valuable to you? Not exactly! Feel free to contact us personally via email through your respective tickets.
          </p>
        </div>
          ...
          {faqItems.map((item, index) => (
            <div key={index} className="bg-[#1A1A1A] rounded overflow-hidden">
              ...
              >
                ...
                <span className={`text-xl ${openIndex !== index ? 'text-brand-400':''}`}>
                  {openIndex === index ? '−' : '+'}
                </span>
              </div>
